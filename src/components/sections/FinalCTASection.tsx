  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden pointer-events-none select-none">
        <p className="font-heading text-[12rem] sm:text-[18rem] font-bold uppercase text-white/[0.03] leading-none tracking-tight whitespace-nowrap">
          OWN IT
        </p>
      </div>
      <div className="absolute inset-0 flex items-start justify-center overflow-hidden pointer-events-none select-none pt-20">
        <p className="font-heading text-[8rem] sm:text-[12rem] font-bold uppercase text-white/[0.02] leading-none tracking-tight whitespace-nowrap">
          NO MORE RENT
        </p>
      </div>
