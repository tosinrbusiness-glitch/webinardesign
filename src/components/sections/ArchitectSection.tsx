      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6">
        <div className="max-w-5xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`transition-all duration-700 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
            <div className="relative">
              <div className="rounded-2xl p-[1px]" style={{ background: 'linear-gradient(145deg, rgba(124, 58, 237, 0.5), rgba(245, 197, 24, 0.2), rgba(124, 58, 237, 0.3))' }}>
                <div className="w-full aspect-[3/4] rounded-2xl flex items-center justify-center overflow-hidden" style={{ background: 'linear-gradient(145deg, rgba(30, 16, 64, 0.8), rgba(20, 10, 45, 0.9))' }}>
                  <div className="text-center p-8">
                    ...
                    <p className="text-[#9a8cb0] text-sm">Portrait</p>
                  </div>
                </div>
              </div>
              {/* Name badge */}
              <div className="absolute bottom-6 left-6 right-6 rounded-xl p-4 text-center" style={{ background: 'linear-gradient(135deg, #f5c518, #e8a900)', boxShadow: '0 0 30px rgba(245, 197, 24, 0.3)' }}>
                <p className="font-heading text-lg font-bold text-[#1a1a2e] uppercase">Dr. Elena Thorne</p>
                <p className="text-[#1a1a2e]/60 text-xs uppercase tracking-wider font-heading">Wealth Strategist & Founder</p>
              </div>
            </div>
          </div>
          ...
          <div className={`space-y-6 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
            <div>
              <p className="text-[#b87aff] font-heading text-xs tracking-[0.35em] uppercase mb-4">The Architect</p>
              <h2 className="font-heading text-4xl sm:text-5xl font-bold uppercase mb-4 leading-tight">
                ...
                <span className="bg-gradient-to-r from-[#f5c518] to-[#ffdf6b] bg-clip-text text-transparent">GUIDE</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-xl p-5 text-center" style={{ background: 'linear-gradient(145deg, rgba(30, 16, 64, 0.7), rgba(15, 8, 35, 0.8))', border: '1px solid rgba(124, 58, 237, 0.25)' }}>
                ...
                <p className="font-heading text-2xl font-bold bg-gradient-to-r from-[#f5c518] to-[#ffdf6b] bg-clip-text text-transparent">15+</p>
                <p className="text-xs text-[#9a8cb0] uppercase tracking-wider font-heading mt-1">Years Experience</p>
              </div>
              <div className="rounded-xl p-5 text-center" style={{ background: 'linear-gradient(145deg, rgba(30, 16, 64, 0.7), rgba(15, 8, 35, 0.8))', border: '1px solid rgba(124, 58, 237, 0.25)' }}>
                <DollarSign className="w-5 h-5 text-primary mx-auto mb-2" style={{ filter: 'drop-shadow(0 0 8px rgba(245, 197, 24, 0.4))' }} />
                <p className="font-heading text-2xl font-bold bg-gradient-to-r from-[#f5c518] to-[#ffdf6b] bg-clip-text text-transparent">$150M+</p>
                <p className="text-xs text-[#9a8cb0] uppercase tracking-wider font-heading mt-1">Wealth Generated</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-foreground font-semibold font-heading">Featured in Forbes, NPR, Philadelphia Inquirer</span>
            </div>
          </div>
        </div>
      </div>
